...
| model-trust.md | Per-species model accuracy and Event Trust: how a model's reliability is judged against expert review and how much a single detection should be believed, both derived, inferred, and model-keyed. |
